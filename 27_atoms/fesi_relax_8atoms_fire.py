...
#på final structure: (struct_type = final, navn match til initial struktur), initial må ha: (converged=1, final_struct_id)
...
if __name__ == "__main__":
    ...
    system_name = 'fesi_8atoms_id' + str(system_id) + '_27'
